...
export default function Trainingcomptia({ params }: { params: { kelas_comptia_Id: string } }) {
    const idkelas = params.kelas_comptia_Id;
  const kelas = comptia_data.find((k) => k.id.toString() === idkelas);
