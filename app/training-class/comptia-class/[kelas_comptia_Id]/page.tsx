// File: app/training-class/comptia-class/[kelas_comptia_Id]/page.tsx
import React from "react";
import { comptia_data } from "../kelas_data_comptia";

type Params = Promise<{ kelas_comptia_Id: string }>;

export default async function TrainingComptia({ params }: { params: Params }) {
  const { kelas_comptia_Id } = await params;
  const kelas = comptia_data.find((k) => k.id.toString() === kelas_comptia_Id);
  ...
  return (
    <div className="container mx-auto px-6 py-6">
      <div className="w-full h-full shadow-lg p-3 rounded-lg bg-white">
        ...
        <div className="lg:basis-2/3 sm:w-full border bg-white p-4 rounded-lg flex-grow">
          ...
          <div className="text-base mb-4">
            Bagi yang berminat bisa kontak kami (pada bagian 'Contact Us') untuk reservasi jadwal
          </div>
