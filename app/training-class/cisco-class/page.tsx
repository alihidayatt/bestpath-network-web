...
export default function TrainingCisco() {
  const thisLink = "./cisco-class/";

  return (
    <div className="container mx-auto px-6 py-6">
      <div className="w-full h-full bg-white shadow-lg p-3 rounded-lg relative overflow-hidden">
        <h1 className="text-2xl font-bold mb-6 text-center">All Cisco Class</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {cisco_data.map((kelas, index) => (
            <div
              key={index}
