...
export default function Traininghuawei({ params }: { params: { kelas_huawei_Id: string } }) {
  const thisLink = "./huawei-class/";

  return (
    <div className="container mx-auto px-6 py-6">
      <div className="w-full h-full bg-white shadow-lg p-3 rounded-lg relative overflow-hidden">
        <h1 className="text-2xl font-bold mb-6 text-center">All Huawei Class</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {huawei_data.map((kelas, index) => (
            <div
              key={index}
